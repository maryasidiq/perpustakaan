<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/home">
        <div class="sidebar-brand-icon">
            ...
            <img src="{{ asset( '/template/img/logo/logo keywork.png')}}">
        </div>
        <div class="sidebar-brand-text mx-3">KeyWork</div>
    </a>
    ...
    @if (Auth::user()->isAdmin == 0)
        <li class="nav-item">
            ...
            <div id="collapseChatBot" class="collapse" aria-labelledby="headingPeminjam"
                data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Chat Bot</h6>
                    <a class="collapse-item" href="{{ route('bot.view')}}">Chat Bot</a>
                </div>
            </div>
        </li>
    @endif
