...
@push('scripts')
    ...
    <script>
        ...
        new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['Buku', 'Kategori', 'Anggota', 'Riwayat Peminjaman'],
                datasets: [{
                    label: 'Jumlah',
                    data: [{{ $buku }}, {{ $kategori }}, {{ $user }}, {{ $jumlah_riwayat }}],
                    backgroundColor: [
                        'rgba(54, 162, 235, 0.2)',
                        'rgba(148, 190, 211, 0.2)',
                        'rgba(75, 192, 192, 0.2)',
                        'rgba(255, 99, 132, 0.2)'
                    ],
                    borderColor: [
...
@section('content')
    ...
    <!-- Chart Section -->
    <h1 class="text-primary">Statistik Dashboard</h1>
    <div class="col-lg-auto ">
        <div class="card mb-4">
            <div class="card-body">
                <canvas id="dashboardChart" width="400" height="80"></canvas>
            </div>
        </div>
